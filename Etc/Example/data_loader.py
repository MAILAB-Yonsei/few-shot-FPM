    ...
    def load_data(self, opt, Settings):
        ...
        for i in range(data_num):                               ## regarding batch size
            ...
            if self.mode == 'Valid' or self.mode == 'Test':
                ...
                cover_range_FT = np.fft.fftshift(np.fft.fft2(cover_range));
                ...
                ass= Settings["arraysize"]
                # print(cover_range_FT.shape , "cover_Range_fT.shape")
                
                seq=self.gseq(ass)
                
            # print(batch_random_index, 'batch_random_index')
            
            for c in (batch_random_index):                            ## regarding 64 size
                ...
                spsize = 0.5e-6;        #sampling pixel size of the camera
        ...
        # print(FPM_datasets.shape , 'FPM_datasets_Shape')
        # print(amp.shape , 'amp')
        # print(phase.shape, 'phase')     
            
            
        # print(FPM_datasets[0].shape , 'FPM_datasets_Shape')
        # print(amp[0].shape , 'amp')
        # print(phase[0].shape, 'phase')
