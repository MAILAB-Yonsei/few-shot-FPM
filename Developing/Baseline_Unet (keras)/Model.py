...
def unet_scale4(sx, sy, nch):
    ...
    conv9 = Conv2D(nfilter, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(up9) # 80, 80, 64, 32
    conv9 = BatchNormalization()(conv9)
    conv9 = Conv2D(nfilter, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv9) # 80, 80, 64, 32
    conv9 = BatchNormalization()(conv9)
